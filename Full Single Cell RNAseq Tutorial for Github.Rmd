# Title: Single Cell RNAseq Tutorial
# Author: Jesus Zeno
# Date: 4/28/2022
...
![Overall Workflow for Single Cell RNAseq](SingleCellRNAseqWorkflow.png)
...
![NCBI Picture of Gene Locus](NCBIGeneLocus.png)
...
![IGV Original output without highlights](IGVOriginalOutput.png)

Step 9A: Go into View->Preferences->Alignments tab and make sure “Color Alignments by” is set to “READ_STRAND”

![IGV Settings for strandedness](IGVSettingsforstrandedness.png)
...
![IGV Colored output for strandedness](IGVColoredOutput.png)
...
![FeatureCounts Combined and Cleaned File Format](FeatureCountsCombinedandCleanedFileFormat.png)
